...
<body class="overlay-scrollbar">
	...
	<!-- main content -->
	<div class="wrapper">
		<p class="link_mark">Home > Lịch sử sự cố > Sự cố #2</p>
		<div class="row justify-content-center">
            ...
            <label>Tài sản liên quan</label>
					...
					<div class="form-item justify-content-center">
						<button type="submit" name="update" onclick="return confirm('Xác nhận LƯU thay đổi?')" value="">Cập
							nhật</button>
						<a class="btn btn-type2" name="cancel" onclick="return confirm('Thay đổi sẽ KHÔNG được lưu?')"
							href="trouble-history.html">Hủy</a>
					</div>
				</form>

				<h2 class="form-title">Xóa sự cố</h2>
				<form>
					<p>Sự cố bị xóa sẽ không thể hoàn tác. Hãy cân nhắc chắc chắn.</p>
					<div class="form-item">
						<button class="btn-danger" type="submit" name="delete-trouble"
							onclick="return confirm('Bạn chắc chắn muốn XÓA sự cố #2?')" value="">Xóa sự cố</button>
					</div>
