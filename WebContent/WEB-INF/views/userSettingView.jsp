	...
	<div class="wrapper">
		...
		<div class="row align-items-center">
			<div class="col-4 col-m-12 col-sm-12">
				<img class="img_description" src="${pageContext.request.contextPath}/assets/image/setting.svg">
			</div>
			<div class="col-8 col-m-12 col-sm-12">
				<h2 class="form-title">Thay đổi mật khẩu</h2>
				<form method="POST" action="${pageContext.request.contextPath}/user/setting">
					<div class="form-item">
					...
					<div class="form-item">
						...
						<input type="password" name="new_password" id="password"  oninput="check_pass()"
                        pattern="[a-zA-Z0-9]{3,20}"
                        title="Mật khẩu chỉ chứa chữ cái hoặc số; dài từ 3 đến 20 ký tự" 
				...
				<form method="POST" action="${pageContext.request.contextPath}/user/setting">
					...
					<p style="color: var(--danger-color);" id="error-mesg"><c:out value="${ errorMessage2}"></c:out></p>
                    <p style="color: var(--danger-color);" id="error-mesg"><c:out value="${ errorMessage3}"></c:out></p>
					<div class="form-item">
